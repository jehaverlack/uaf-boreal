...
- `x86_64`: download `boreal-v0.1.4-linux-x86_64`.
- `aarch64` or `arm64`: download `boreal-v0.1.4-linux-aarch64`.
- `armv7l`: download `boreal-v0.1.4-linux-armv7`.
...
```bash
cd ~/Downloads
chmod +x boreal-v0.1.4-linux-x86_64
```
...
```bash
sha256sum boreal-v0.1.4-linux-x86_64
```
