...
- `x86_64`: download `boreal-v0.1.3-linux-x86_64`.
- `aarch64` or `arm64`: download `boreal-v0.1.3-linux-aarch64`.
- `armv7l`: download `boreal-v0.1.3-linux-armv7`.
...
```bash
sha256sum boreal-v0.1.3-linux-x86_64
```
